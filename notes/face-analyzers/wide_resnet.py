...
class WideResNet:
    ...
    def __call__(self):
        ...
        inputs = Input(shape=self._input_shape, name='image')
        ...
        predictions_g = Dense(units=2, kernel_initializer=self._weight_init, use_bias=self._use_bias,
                              kernel_regularizer=l2(self._weight_decay), activation="softmax", name='prediction_g')(
            flatten)
        predictions_a = Dense(units=101, kernel_initializer=self._weight_init, use_bias=self._use_bias,
                              kernel_regularizer=l2(self._weight_decay), activation="softmax", name='predictions_a')(
            flatten)
